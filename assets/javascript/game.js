...
var words = ["apple", "banana", "peach", "cat", "mouse", "horse", "car", "plane", "ship"];

var maxAttempt = 11;            // defined maximum allowed guesses

var winRecord = 0;              //
var gameOver = true;            // game initial status when open the page
...
function check(input) {
    ...
    if ((i != -1)) {
        //bingo!
        currentWord=currentWord.replace(input," ") //replace the char with " "
        inputRecord+=input;
        displayWord[i]=input;
